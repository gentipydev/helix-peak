...
from bake_impact import BASES, COMPLEMENT, ROOT, BakeError, phred_of, windows
...
def atlas_template() -> str:
    skill = ROOT.parent / ".claude/skills/alphagenome-atlas-website-links"
    variant = "chr1:1:A>C"
...
def bake(slug: str, client, template: str) -> None:
    source = ROOT / f"assets/impact/{slug}_avi.json"
    ...
    out = ROOT / f"assets/impact_explanations/{slug}.json"
