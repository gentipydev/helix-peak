"""Bake `assets/mock/gene_*.json` — the records the app serves with no backend.
...
should learn to do before these records are replaced by live calls.
    ...
    python3 tool/mock/build_gene_record.py --all
    python3 tool/mock/build_gene_record.py --target dystrophin
"""
...
if __name__ == "__main__":
    ...
    for target in chosen:
        ...
        size = write(payload, ROOT / target.mock_asset)
        span = payload["location"]["end"] - payload["location"]["start"] + 1
        note = ""
