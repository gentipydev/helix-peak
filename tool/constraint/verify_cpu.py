...
decimals is the point.
    ...
    tool/.esm-venv/bin/python -u tool/constraint/verify_cpu.py --target lysozyme
...
from score_protein import AMINO_ACIDS, MODEL, REVISION, ROOT

sys.path.insert(0, str(ROOT / "tool"))
from targets import BY_SLUG, Target  # noqa: E402
